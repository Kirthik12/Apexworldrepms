...
- Create Angular project with ng: `ng new apex_world_angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`apex_world_angular.client.esproj`).
